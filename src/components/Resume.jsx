...
const educationData = [
  {
    ...
    year: "2021 - 2025",
    description: "Graduated with a 3.8 GPA. Specialized in Software Engineering and Database Management. Capstone project focused on AI-driven inventory systems.",
  },
  {
    id: 2,
    degree: "TTC Diploma",
    ...
    year: "2022 - 2023",
    description: "Completed intensive teacher training program focusing on modern pedagogical methodologies and classroom management.",
  },
  {
    id: 3,
    ...
    year: "2009 - 2020",
    description: "Focus on Mathematics and Physics. Awarded 'Student of the Year' in 2018 for excellence in science competitions.",
  }
];
...
const experienceData = [
  {
    ...
    description: "Developed and maintained full-stack web applications using React, Node.js, and MongoDB. Collaborated with senior developers to implement new features and optimize performance.",
  },
  {
    id: 2,
    ...
    description: "Instructed students on relational database design, SQL programming, and database administration concepts. Developed course materials and practical exercises.",
  }
];
...
const TimelineCard = ({ data, index }) => {
  ...
  const cardClasses = `
    ...
    ${isLeft 
      ? 'border-blue-500 md:text-right rounded-tr-none' 
      : 'border-purple-500 md:text-left rounded-tl-none'}
  `;
  ...
  return (
    <div className="relative w-full">
      ...
      <div className={`absolute top-6 w-5 h-5 rounded-full z-20
      ...
      <div className={wrapperClasses}>
         <div className={cardClasses}>
           ...
           {/* Year Badge */}
           <span className={`inline-block px-3 py-1 rounded-full text-sm font-bold mb-3 border bg-[#1a1a1a]
...
const TimelineSection = ({ title, icon, data, accentColor }) => {
  return (
    <div className="mb-24 relative">
       {/* Section Header */}
      <div className="flex items-center justify-center gap-4 mb-16">
        <div className={`p-3 rounded-full bg-${accentColor}-900/20 border border-${accentColor}-900/50 shadow-[0_0_15px_-3px_rgba(59,130,246,0.3)]`}>
            {icon}
        </div>
